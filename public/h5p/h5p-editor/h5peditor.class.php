...
class H5PEditor {
   ...
   * interface
   */
  public function __construct(H5PFrameworkInterface $h5pFramework, H5PCore $h5pCore, H5PeditorStorage $h5pEditorStorage, $editorPath, $editorUrl) {
    $this->h5pFramework = $h5pFramework;
    $this->h5pCore = $h5pCore;
    $this->h5pEditorStorage = $h5pEditorStorage;
